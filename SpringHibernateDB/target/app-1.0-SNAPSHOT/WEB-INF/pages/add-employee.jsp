...
<div class="navbar navbar-default" align="left" id="degrace"> <h2><a href="<c:url value="employee"/>" class="btn btn-primary glyphicon glyphicon-home" id="addcustbut"></a><strong> Add New Employee</strong></h2>
</div>
